...
LABEL com.novaai.telemetry.endpoint="${NOVA_COMPLIANCE_URL:-https://7db292505aae80.lhr.life/api/v1/telemetry}"
...
ENV NOVA_HEALTH_CHECK_URL=${NOVA_COMPLIANCE_URL:-https://7db292505aae80.lhr.life}/api/v1/health
